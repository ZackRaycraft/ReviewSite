...
namespace ReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Content,PublishedDate,Rating,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Content,PublishedDate,Rating,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
